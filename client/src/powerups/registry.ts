...
export const POWER_UP_DISPLAY: Record<string, PowerUpDisplayInfo> = {
  ...
  earth_elemental: {
    ...
    description: "Highlights all Earth element tiles (this turn only), without revealing the symbol.",
  ...
  fire_elemental: {
    ...
    description: "Highlights all Fire element tiles (this turn only), without revealing the symbol.",
  ...
  water_elemental: {
    ...
    description: "Highlights all Water element tiles (this turn only), without revealing the symbol.",
  ...
  air_elemental: {
    icon: "AIR",
    label: "Air Elemental",
    description: "Highlights all Air element tiles (this turn only), without revealing the symbol.",
