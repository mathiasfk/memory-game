...
// are recovered; they can still occur under race when the Hub closes the channel before the game
// has cleared its reference, and are logged at Debug as expected during disconnects.
